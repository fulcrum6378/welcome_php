    ...
    switch (hl) {
        case "fa":
            ...
            $("blockquote").html(
                ...
                "طراحی کردم.<br>فریمورک هایی که به اونها مسلط هستم: جنگو، Node.js و تنسورفلو هستند " +
                "و با دیتابیس های مای اسکیوال، اسکیولایت و مانگودیبی کار کردم.<br>گاهی اوقات به تمرین " +
                "«یادگیری ماشینی» میپردازم چه با استفاده از TensorFlow و چه با کد های خودم. همچنین به سیستم " +
                "عامل های لینوکسی، یونیکسی (FreeBSD و OpenBSD) و Windows Server و مسلط هستم."
            );
